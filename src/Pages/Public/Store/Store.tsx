...
import { BackgroundPhoto, Container, MainSection, Page, ProductSection, SearchTab, ShopInfo, Top } from "./Store.styles";
                ...
                <ShopInfo>
                    <div className="title">
                        ...
                        <div className="buttons">
                            <Button 
                                className="button" width={117} 
                                background="linear-gradient(180deg, #FF7612 0%, #FF001F 100%)" 
                                color="#FFFFFF"><img src={profileAdd}/>follow</Button>
                            <Button className="button" width={117} 
                                background="linear-gradient(180deg, #FF7612 0%, #FF001F 100%)" 
                                color="#FFFFFF"><img src={message}/>Message</Button>
                            <Button className="button" 
                                width={117} border="1px solid #FA3434" 
                                color="#FA3434"><img src={report}/>Report</Button>
                        </div>
                    </div>
